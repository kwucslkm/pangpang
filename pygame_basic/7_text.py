...
# 캐릭터 불러오기
character = pygame.image.load("C:\\projectWeb\\pythonworkspace\\pygame_basic\\character.png")
...
# 적 캐릭터
enemy = pygame.image.load("C:\\projectWeb\\pythonworkspace\\pygame_basic\\enemy.png")
...
while running:
    ...
    timer_text = game_font.render("Time: " + str(int(total_time - elapsed_time)), True, (255, 255, 255)) 
    # 출력할 글자, True, 글자 색상
    screen.blit(timer_text, (10, 10)) # 타이머 텍스트 그리기
    # 시간이 0 이하이면 게임 종료
